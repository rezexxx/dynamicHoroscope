...
if (isset($_POST["submit"])) {
    ...
    $sql = "INSERT INTO users (username, first_name, last_name, password, birthday,gender, is_admin) VALUES ('$username','$firstname','$lastname','$password','$birthday','$gender','1')";
...
<body>
    <h1>Register as Admin (INSECURE)</h1>
